...
def lambda_handler(event, context):
    ...
    input2_headers = {
    'cookie': 'csrftoken=WvWLrENu05ETxo8ywkCOb9b8alpVAMPk6WOg3fhk8apYu7wMJz62MiPWNYnnFzYL; sessionid=35lghopnbktufyb8ulkhje0hn4uqc7m7; messages="60fd922b0ef183fb4a27cb1e853840d1735e3acb$[[\"__json_message\"\0540\05430\054\"Items must be selected in order to perform actions on them. No items have been changed.\"]]"',
    }
